...
class ReceptionistLogIn( object ):
    ...
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(921, 393)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.ApproveButton = QtWidgets.QPushButton(self.centralwidget)
        self.ApproveButton.setGeometry(QtCore.QRect(299, 330, 101, 31))
        font = QtGui.QFont()
        ...
        self.label_2.setGeometry(QtCore.QRect(370, 0, 311, 160))
        self.label_2.setText("")
        self.label_2.setPixmap(QtGui.QPixmap("Logo.png"))
        self.label_2.setObjectName("label_2")
        self.label_3 = QtWidgets.QLabel(self.centralwidget)
        self.label_3.setGeometry(QtCore.QRect(10, 131, 111, 20))
        font = QtGui.QFont()
        ...
        self.tableWidgetAppointment.setGeometry(QtCore.QRect(0, 160, 999, 161))
        ...
        self.ShowAppButton.setGeometry(QtCore.QRect(540, 330, 151, 30))
        font = QtGui.QFont()
        font.setFamily("Segoe UI Semibold")
        font.setPointSize(9)
        font.setBold(True)
        ...
        self.LogOutButton.setGeometry(QtCore.QRect(5, 5, 100, 31))
        font = QtGui.QFont()
        font.setFamily("Segoe UI Semibold")
        font.setPointSize(9)
        font.setBold(True)
        ...
        self.DenyButton.setGeometry(QtCore.QRect(420, 330, 101, 31))
        font = QtGui.QFont()
        font.setFamily("Segoe UI Semibold")
        font.setPointSize(9)
        font.setBold(True)
        ...
        self.PatientName.setGeometry(QtCore.QRect(130, 330, 151, 31))
        self.PatientName.setObjectName("PatientName")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(10, 330, 99, 31))
        font = QtGui.QFont()
        font.setFamily("Segoe Print")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_3.setText(_translate("MainWindowAdmin", "Rendez-vous"))
        ...
        item.setText(_translate("MainWindowAdmin", "L'état de santé"))
        ...
        self.ShowAppButton.setText(_translate("MainWindowAdmin", "Afficher les rendez-vous"))
        self.LogOutButton.setText(_translate("MainWindowAdmin", "Se déconnecter"))
        self.DenyButton.setText(_translate("MainWindowAdmin", "Refuser"))
        self.label.setText(_translate("MainWindowAdmin", "Nom du Patient"))
